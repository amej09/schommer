...
class Standard_action_module_d1253c692f4582a8bc19c6a0fcf17d0987abfc2e extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output30 .= '" class="form-control input-login t3js-clearable t3js-login-username-field" autofocus="autofocus" autocomplete="username" required="required" spellcheck="false" />
                <div role="status" class="form-notice-capslock hidden t3js-login-alert-capslock">
                    <img aria-hidden="true" src="';
$array36 = array (
);
...
$output30 .= '" class="form-control input-login t3js-clearable t3js-login-password-field" autocomplete="current-password" required="required" spellcheck="false" />
                <div role="status" class="form-notice-capslock hidden t3js-login-alert-capslock">
                    <img aria-hidden="true" src="';
$array46 = array (
);
