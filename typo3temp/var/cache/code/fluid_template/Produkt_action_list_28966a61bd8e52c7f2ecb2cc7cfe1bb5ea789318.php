...
class Produkt_action_list_28966a61bd8e52c7f2ecb2cc7cfe1bb5ea789318 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output0 .= '"
            ...
            <div class="icon-input">
                <input type="search" name="searchTerm" class="search" value="" placeholder="Suche..." />
                 ...
                 <button type="submit" class="img-btn" onclick="submitsearch()"><img src="/schommer/fileadmin/user_upload/lupe.svg" /></button>
