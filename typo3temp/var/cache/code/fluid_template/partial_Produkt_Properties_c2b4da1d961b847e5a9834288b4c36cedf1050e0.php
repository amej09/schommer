...
class partial_Produkt_Properties_c2b4da1d961b847e5a9834288b4c36cedf1050e0 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$arguments1['key'] = 'tx_produktshow_domain_model_produkt.titel';
...
$arguments4['key'] = 'tx_produktshow_domain_model_produkt.preis';
...
$output0 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('produkt.preis', $array6)]);
...
$arguments7['key'] = 'tx_produktshow_domain_model_produkt.lager';
...
$arguments10['key'] = 'tx_produktshow_domain_model_produkt.lieferzeit';
...
$output0 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('produkt.lieferzeit', $array12)]);
...
$arguments13['key'] = 'tx_produktshow_domain_model_produkt.dateiname';
...
$output0 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('produkt.dateiname', $array15)]);
