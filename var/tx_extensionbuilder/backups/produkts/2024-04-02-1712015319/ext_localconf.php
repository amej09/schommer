...
(static function() {
    \TYPO3\CMS\Extbase\Utility\ExtensionUtility::configurePlugin(
        ...
        [
            ...
            \Produktsvendor\Produkts\Controller\KategoryController::class => 'index, list, show, new, create, edit, update, delete'
        ],
        // non-cacheable actions
        [
            \Produktsvendor\Produkts\Controller\ProduktController::class => 'create, update, delete',
            \Produktsvendor\Produkts\Controller\KategoryController::class => 'create, update, delete'
        ]
    );
